...
public class ulsanactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ulsanactivity);
    ...
    public void onClickUlju(View v)
    {
        SandData("35.52219","129.24265",R.raw.ulsanuljucctv,R.raw.ulsanuljulamp,"울주");

    }

    public void onClickUlsan_Bukgu(View v)
    {
        SandData("35.58299","129.36154",R.raw.ulsanbukgucctv,R.raw.ulsanbukgulamp,"북구");
    }

    public void onClickUlsan_Junggu(View v)
    {
        SandData("35.56936","129.33261",R.raw.ulsanjunggucctv,R.raw.nulll,"중구");
    }
    public void onClickUlsan_Namgu(View v)
    {
        SandData("35.54380","129.33008",R.raw.ulsannamgucctv,R.raw.ulsannamgulamp,"남구");
    }
    public void onClickUlsan_Donggu(View v)
    {
        SandData("35.50479","129.41659",R.raw.ulsandonggucctv,R.raw.ulsandonggulamp,"동구");
    }
